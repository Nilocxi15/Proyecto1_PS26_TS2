...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/auditor/profile.css') }}">
...
<body>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home-auditor') }}"><i class="bi bi-house"></i>
                                    Inicio</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('profile-auditor') }}"><i
    ...
    <script src="{{ asset('js/auditor/profile.js') }}"></script>
</body>
